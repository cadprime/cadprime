...
import archive from "../img/icons/archive.svg";
    ...
    <div className="container mt-6 mb-6">
      ...
      <div className="horizontal-scroll-full">
        <div className="cards">
          ...
          <Card type="secondary">
            <h2>
              payroll <span className="bold"> pro</span>
            </h2>
            <span className="subtext">$60.00/mo.*</span>
            <p>
              Cadprime Payroll Pro is your whole process payroll officer partner
              provider. It offers the basic payroll system’s main features plus
              add-on features that are very helpful for analysis and efficient
              reports generated by the Accounting and/or Human Resources
              Departments.
            </p>
